...
//Delete Product
    ...
    if ($_POST) {
        ...
        if (!empty($_FILES)) {
            ...
            $dbpath = '/offsidetrap/images/products/' . $uploadName;
            if ($mimeType != 'image') {
    ...
    while ($product = mysqli_fetch_assoc($presults)) :
        ...
        ?>
            <tr>
                <td>
                    <!--<a class="btn btn-sm btn-success" href="products.php?edit=<?php echo $product['id']; ?>"><span class="glyphicon glyphicon-pencil"></span></a>-->
                    <a class="btn btn-sm btn-danger" href="products.php?delete=<?php echo $product['id']; ?>"><span class="glyphicon glyphicon-remove"></span></a>
                </td>
                <td><?php echo $product['title']; ?></td>
                <td><?php echo money($product['price']); ?></td>
                <td><?php echo $category; ?></td>
                <td>
                    <a class="btn btn-sm btn-warning" href="products.php?featured=<?php echo (($product['featured'] == 0) ? '1' : '0'); ?>&id=<?php echo $product['id']; ?>"><span class="glyphicon glyphicon-<?php echo (($product['featured'] == 1) ? 'minus' : 'plus'); ?>"></span></a>&nbsp; <?php echo (($product['featured'] == 1) ? 'Featured Product' : ''); ?>
                </td>
                <td>0</td>
            </tr>
        <?php endwhile; ?>
